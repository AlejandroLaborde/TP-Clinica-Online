...
export class RegistroService {
  ...
  public altaDatosUsuario( usuario: Usuario , imagen1, imagen2){
    this.fileService.subirArchivo(usuario.mail+"_img1",imagen1,{nombre:usuario.nombre,apellido:usuario.apellido}).then((img)=>{
      this.fileService.subirArchivo(usuario.mail+"_img2",imagen2,{nombre:usuario.nombre,apellido:usuario.apellido}).then(img2=>{
